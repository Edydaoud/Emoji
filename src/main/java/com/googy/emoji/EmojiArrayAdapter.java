...
final class EmojiArrayAdapter extends ArrayAdapter<Emoji> {
  @Nullable private final com.googy.emoji.VariantEmoji variantManager;

  @Nullable private final OnEmojiClickListener listener;
  @Nullable private final OnEmojiLongClickListener longListener;

  EmojiArrayAdapter(@NonNull final Context context, @NonNull final Emoji[] emojis, @Nullable final com.googy.emoji.VariantEmoji variantManager,
  ...
  @NonNull @Override public View getView(final int position, final View convertView, @NonNull final ViewGroup parent) {
    com.googy.emoji.EmojiImageView image = (com.googy.emoji.EmojiImageView) convertView;
